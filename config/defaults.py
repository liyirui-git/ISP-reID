...
_C.MODEL.IF_USE_ANGLE_MARGIN = True
_C.MODEL.ANGLE_JSON_PATH = ""
_C.MODEL.SAME_ID_DIFF_VIEW = True
_C.MODEL.SAME_ID_DIFF_VIEW_WEIGHT = 0.1
_C.MODEL.SAME_ID_DIFF_VIEW_MARGIN = 0.0
_C.MODEL.DIFF_ID_SAME_VIEW = True
_C.MODEL.DIFF_ID_SAME_VIEW_WEIGHT = 0.1
_C.MODEL.DIFF_ID_SAME_VIEW_MARGIN = 0.0
_C.MODEL.SAME_ID_SAME_VIEW = True
_C.MODEL.SAME_ID_SAME_VIEW_WEIGHT = 0.1
_C.MODEL.SAME_ID_SAME_VIEW_MARGIN = 0.0

_C.MODEL.IF_USE_MULTI_ANGLE_MARGIN = False
_C.MODEL.MULTI_SAME_ID_SAME_VIEW_WEIGHT = 0.1
_C.MODEL.MULTI_SAME_ID_NEIGHBOR_VIEW_WEIGHT = 0.1
_C.MODEL.MULTI_SAME_ID_DIFF_VIEW_WEIGHT = 0.1
_C.MODEL.MULTI_DIFF_ID_SAME_VIEW_WEIGHT = 0.1

_C.MODEL.MULTI_SAME_ID_SAME_VIEW_MARGIN = 0.04
_C.MODEL.MULTI_SAME_ID_NEIGHBOR_VIEW_MARGIN = 0.08
_C.MODEL.MULTI_SAME_ID_DIFF_VIEW_MARGIN = 0.15
_C.MODEL.MULTI_DIFF_ID_SAME_VIEW_MARGIN = 0.6
